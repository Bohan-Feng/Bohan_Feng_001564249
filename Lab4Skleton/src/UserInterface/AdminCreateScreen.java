...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private boolean passwrodPatternCorrect(String text) {
    ...
    private boolean validateInfo(){
        ...
        || txtPword.getText().equals("")
        || txtRePword.getText().equals("")){
        ...
        if(!userNamePatternCorrect(txtUser.getText())){
            javax.swing.JOptionPane.showMessageDialog(null, 
            "Username should be in the format of xx_xx@xx.xx");
            return false;
        }

        if(!passwrodPatternCorrect(txtPword.getText())){
            javax.swing.JOptionPane.showMessageDialog(null, 
            "Password should be at least 6 digits and contain at least"+ 
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnCreateActionPerformed
        if(validateInfo()){
            if(radioCustomer.isSelected()){
                Customer newCus = new Customer(txtPword.getText(), txtUser.getText());
                admin.custDir.add(newCus);
            }
            if(radioSupplier.isSelected()){
                Supplier newSupp = new Supplier(txtPword.getText(), txtUser.getText());
                admin.suppDir.add(newSupp);
            }
            javax.swing.JOptionPane.showMessageDialog(null, 
            "create success");

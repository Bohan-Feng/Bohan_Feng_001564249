...
public class ViewOrderItemDetailJPanel extends javax.swing.JPanel {
    ...
    ViewOrderItemDetailJPanel(JPanel upc, OrderItem oi) {
        initComponents();
        this.upc = upc;
        this.oi = oi;
        txtProductName.setText(oi.getProduct().getProdName());
        txtProductId.setText(oi.getProduct().getModelNumber() + "");
        txtPaidPrice.setText(oi.getSealsPrice() + "");
        txtQuantity.setText(oi.getQuanity() + "");
        txtSalesPrice.setText(oi.getProduct().getPrice() + "");
    }
